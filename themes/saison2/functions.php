...
function child_enqueue_styles()
{
	...
	// wp_enqueue_style('child-main-style', get_stylesheet_directory_uri() . '/sass/style.css', array('child-main-style-bootstrap'), CHILD_VERSION, 'all');
	wp_enqueue_style('child-main-style', get_stylesheet_directory_uri() . '/sass/style.css', array(), CHILD_VERSION, 'all');
	// Scripts
