    ...
    <main class="main">
        ...
        <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-primary">
            <div class="container col-12 col-md-8 col-lg-6">
                <a class="navbar-brand text-uppercase fs-3" href="<?php echo home_url('/'); ?>">saison 2</a>
            ...
            <div class="container bg-secondary">
                ...
                <div class="row py-5">
                    ...
                    <div class="col-sm-12 col-lg-8 order-sm-0 order-lg-1 d-flex justify-content-center align-items-center">
                        <h2 class="display-3 text-center text-light text-uppercase ">Formation Saison 2</h2>
                    </div>
                </div>
            </div>
        </section>